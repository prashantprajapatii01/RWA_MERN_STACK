                ...
                <div className="container">
                    <div className="row gy-5">
                        <div className="col-lg-6">
                            <div className="faq-accordion accordion accordion-flush" id="accordionFlushExample"
                                data-aos="fade-right">
                                <h5>Frequently Asked Questions</h5>

                                {FaqStateData?.filter(x => x.status)?.map(item => {
                                    return <div className="faq-item accordion-item" key={item.id}>
                                        <h2 className="accordion-header">
                                            <button className="faq-button accordion-button collapsed" type="button"
                                                ...
                                                <span className="plus">
                                                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg" className="fill-current text-qpurple">
                                                        <path
